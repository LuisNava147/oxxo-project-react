...
}})
{
    ...
    return (
        ...
        <h1 className="w-full font-bond text-white text-center text-2xl py-2 ">Nombre del producto: {product.productName}</h1>
        <h2 className="text-xl font-bold text-white text-center">Precio: {product.price}</h2>
        <h2 className="text-md font-bond text-white text-center py-2">Cant. de sellos: {product.countSeal}</h2>
        </div>
